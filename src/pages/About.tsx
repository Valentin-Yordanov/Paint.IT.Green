      ...
      <section className="container py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            <Link to="/learn" className="bg-card border rounded-lg p-6 hover:shadow-lg transition-all hover:scale-105 cursor-pointer">
            ...
            <Link to="/community" className="bg-card border rounded-lg p-6 hover:shadow-lg transition-all hover:scale-105 cursor-pointer">
            ...
            <Link to="/compete" className="bg-card border rounded-lg p-6 hover:shadow-lg transition-all hover:scale-105 cursor-pointer">
            ...
            <Link to="/faq" className="bg-card border rounded-lg p-6 hover:shadow-lg transition-all hover:scale-105 cursor-pointer">
