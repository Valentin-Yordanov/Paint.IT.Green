  ...
  const cards = [
    {
      to: "/our-goal",
      icon: Target,
      title: t("about.ourGoal"),
      desc: t("about.ourGoalDesc"),
      gradient: "from-emerald-500 to-teal-600",
    },
    {
      to: "/our-community",
      icon: Users,
      title: t("about.ourCommunity"),
      desc: t("about.ourCommunityDesc"),
      gradient: "from-sky-500 to-blue-600",
    },
    {
      to: "/our-impact",
      icon: Leaf,
      title: t("about.ourImpact"),
      desc: t("about.ourImpactDesc"),
              ...
              <Link key={index} to={card.to} className="group">
                <Card className="h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-card/80 backdrop-blur-sm overflow-hidden">
                  <CardContent className="p-6 space-y-4 relative">
                    ...
                    <div
                      className={`h-12 w-12 rounded-xl bg-gradient-to-br ${card.gradient} flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300`}
                    >
