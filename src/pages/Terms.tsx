  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="container py-16 max-w-4xl prose prose-slate dark:prose-invert">
        ...
        <p>
          By accessing and using EcoLearn, you accept and agree to be bound by the terms and provisions of this agreement.
        </p>

        <h2>Use of Platform</h2>
        <p>EcoLearn is intended for educational purposes. Users agree to:</p>
        <ul>
        ...
        <p>
          Participants in competitions must follow all rules and guidelines. EcoLearn reserves the right to disqualify participants who violate competition rules or engage in fraudulent activities.
        </p>

        <h2>Content Ownership</h2>
        <p>
          Users retain ownership of the content they post, but grant EcoLearn a license to use, display, and distribute that content within the platform.
        </p>
        ...
        <h2>Contact</h2>
        <p>
          Questions about these Terms of Service can be directed to legal@ecolearn.org.
        </p>
      </section>
    </div>
  );
